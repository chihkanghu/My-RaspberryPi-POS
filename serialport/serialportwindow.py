...
class SerialPortWindow(QtGui.QMainWindow,serialportform.Ui_SerialPortWindow):
    ...
    def initForms(self):
        ...
        self.comboBoxBaud.setCurrentIndex(len(bauds) - 7)
    ...
    def __open_send_file__(self):
        ...
        try:
            ...
            print(e)
            QtGui.QMessageBox.critical(self,u"Open File",u"File can not be openned!")
    ...
    def open_serial_port(self):
        if  self._serial_context_.isRunning():
            ...
            try:
                ...
                QtGui.QMessageBox.critical(self,u"Open Port",u"Fail to open the COM!")  
